...
PARAMS = {
    "cvpr18": {
        ...
        "class_descr_path": "/home/data/models/gtsrbcnn/cvpr18/classes_to_sign_descr.csv",
        "input_tensor_name": "features:0",
        "output_tensor_name": "Softmax:0",
        "last_conv_name": "add_6:0",
        "last_fc_name": "add_9:0",
        "add_feed_tensors": {
            "Placeholder:0": 1.0
        },
    ...
    "usenix21": {
        "meta_graph_path": "/home/data/models/gtsrbcnn/usenix21/gtsrbcnn_scratch.meta",
        "restore_path": "/home/data/models/gtsrbcnn/usenix21/gtsrbcnn_scratch",
        "class_descr_path": "/home/data/models/gtsrbcnn/usenix21/classes_to_sign_descr.csv",
    ...
    "usenix21adv": {
        "meta_graph_path": "/home/data/models/gtsrbcnn/usenix21adv/gtsrbcnn_adv.meta",
        "restore_path": "/home/data/models/gtsrbcnn/usenix21adv/gtsrbcnn_adv",
        "class_descr_path": "/home/data/models/gtsrbcnn/usenix21adv/classes_to_sign_descr.csv",
        "input_tensor_name": "image:0",
        "output_tensor_name": "softmax/Softmax:0",
        "last_conv_name": "last_conv/Relu:0",
        "last_fc_name": "last_fc/BiasAdd:0",
    ...
    "cvpr18iyswim": {
        "meta_graph_path": "/home/data/models/gtsrbcnn/cvpr18iyswim/model.meta",
        "restore_path": "/home/data/models/gtsrbcnn/cvpr18iyswim/model",
        "class_descr_path": "/home/data/models/gtsrbcnn/usenix21adv/classes_to_sign_descr.csv",
...
class GtsrbCNNModel(Detector):
    ...
    def __init__(self, saliency=False, model_id1=None, *args, **kwargs):
        ...
        if model_id1 is not None:
            assert model_id1 in PARAMS, "model_id1 %s is not in parameters in gtsrbcnn/detector.py" % model_id1
    ...
    def xrai(self, image, prediction_class, binarize=False, threshold=0.3):
        assert self.saliency, "Model was constructed with salience=False"
        ...
        # most salient 30%
        percentile = int((1 - threshold) * 100)
        xrai_salient_mask = xrai_attributions > np.percentile(xrai_attributions, percentile)

        xrai_im_mask = np.ones(image.shape)
        # xrai_im_mask = xrai_im_mask  # reset the image to be between 0 and 1
